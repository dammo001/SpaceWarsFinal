(function () {
	...
	var createTracker = function () {
		var trackerId; 
		newTracker(); 
			that.trackerId = setInterval(function(){ 
	...
	var createFloater = function () {
		var floaterId; 
		newFloater(); 
		this.floaterAdded = true; 
		console.log("CREATE FLOATER");

			that.floaterId = setInterval(function(){ 
	...
	var createDodger = function () {
		var dodgerId; 
		newDodger(); 
			that.DodgerId = setInterval(function(){ 
	...
	Game.prototype.end = function(gameView, ctx){
		var that = this;
		clearInterval(this.floaterId); 
		clearInterval(this.trackerId);
		clearInterval(this.dodgerId);
